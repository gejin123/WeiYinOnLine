    ...
    public void initView()
    {
        ...
        connectSeller.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {EMClient.getInstance().getCurrentUser()!=null
                ...
                try
                {
                    ...
                    {
                        Intent gotoChatIntent=new Intent(StoreDetailActivity.this,LoginActivity.class);
                        gotoChatIntent.putExtra("storename",name);
                        startActivity(gotoChatIntent);
                    }
                    else
                    {
                        Intent gotoLonInIntent=new Intent(StoreDetailActivity.this,LoginActivity.class);
                        startActivity(gotoLonInIntent);
                    }
                }
                catch (NullPointerException e)
                {
                    Toast.makeText(StoreDetailActivity.this,"您还未登录，请先登录！", Toast.LENGTH_SHORT).show();
                    Intent gotoLonInIntent=new Intent(StoreDetailActivity.this,LoginActivity.class);
                    startActivity(gotoLonInIntent);
                }

               /* else {
                    Intent gotoLoginIntent=new Intent(StoreDetailActivity.this,LogIn.class);
        ...
        gotomapImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               // Intent gotoMapIntent=new Intent(StoreDetailActivity.this,GoToMapActivity.class);
